...
const name$2 = "Disrupción creativa";
const role = "Realidades (X)";
const disciplines = [
  "(Virtual)",
  "(Aumentada)",
  "(Extendida)",
...
const Navbar = () => {
  ...
  return /* @__PURE__ */ jsxs("header", { className: styles$m.navbar, ref: headerRef, children: [
    ...
    /* @__PURE__ */ jsxs("nav", { className: styles$m.nav, children: [
      /* @__PURE__ */ jsx("div", { className: styles$m.navList, children: navLinks.map(({ label, pathname }) => /* @__PURE__ */ jsx(
        Link$1,
        {
          unstable_viewTransition: true,
          prefetch: "intent",
...
const NavbarIcons = ({ desktop }) => /* @__PURE__ */ jsx("div", { className: styles$m.navIcons, children: socialLinks.map(({ label, url: url2, icon: icon2 }) => /* @__PURE__ */ jsx(
  "a",
  {
...
const Footer = ({ className }) => /* @__PURE__ */ jsx("footer", { className: classes(styles$i.footer, className), children: /* @__PURE__ */ jsxs(Text, { size: "s", align: "center", children: [
  ...
  /* @__PURE__ */ jsx(Link, { secondary: true, className: styles$i.link, href: "/humans.txt", target: "_self", children: "Realidades (x)" })
] }) });
...
const Carousel = lazy(
  () => import("./index-nBHJZga4.js").then((module) => ({ default: module.Carousel }))
);
const Armor = lazy(() => import("./armor-BvQEz0VZ.js").then((module) => ({ default: module.Armor })));
...
const meta$7 = () => {
  return baseMeta({ title: title$5, description: description$4, prefix: "Projects" });
};
...
const container = "_container_1lkfa_3";
...
const Earth = lazy(() => import("./earth-CbW7wy-R.js").then((module) => ({ default: module.Earth })));
const EarthSection = lazy(
  () => import("./earth-CbW7wy-R.js").then((module) => ({ default: module.EarthSection }))
);
...
const meta$6 = () => {
  return baseMeta({ title: title$4, description: description$3, prefix: "Projects" });
};
const SmartSparrow = () => {
...
const divider = "_divider_11xm9_159";
  ...
  return /* @__PURE__ */ jsxs(
    "article",
    {
      ...
      children: [
        ...
        featured && !!banner2 && /* @__PURE__ */ jsx("div", { className: styles$b.postImage, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            noPauseButton: true,
...
const meta$4 = () => {
  return baseMeta({ title: title$3, description: description$2, prefix: "Projects" });
};
const Slice = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
...
const content$2 = "_content_opidu_531";
const styles$9 = {
  post,
  header,
  headerText,
...
const Post = ({ children, title: title2, date: date2, banner: banner2, timecode: timecode2 }) => {
  ...
  return /* @__PURE__ */ jsxs("article", { className: styles$9.post, children: [
    /* @__PURE__ */ jsxs(Section, { children: [
      banner2 && /* @__PURE__ */ jsxs("div", { className: styles$9.banner, ref: imageRef, children: [
        /* @__PURE__ */ jsx("div", { className: styles$9.bannerImage, children: /* @__PURE__ */ jsx(Image$1, { role: "presentation", src: banner2, placeholder: placeholder2, alt: "" }) }),
        /* @__PURE__ */ jsx("div", { className: styles$9.bannerImageBlur, children: /* @__PURE__ */ jsx(
          Image$1,
          {
            role: "presentation",
            src: placeholder2,
      ...
      /* @__PURE__ */ jsx("header", { className: styles$9.header, children: /* @__PURE__ */ jsxs("div", { className: styles$9.headerText, children: [
        /* @__PURE__ */ jsx(Transition, { in: true, timeout: msToNum(tokens.base.durationM), children: ({ visible, nodeRef }) => /* @__PURE__ */ jsxs("div", { className: styles$9.date, ref: nodeRef, children: [
          /* @__PURE__ */ jsx(Divider, { notchWidth: "64px", notchHeight: "8px", collapsed: !visible }),
          /* @__PURE__ */ jsx(Text, { className: styles$9.dateText, "data-visible": visible, children: dateTime })
        ] }) }),
        /* @__PURE__ */ jsx(Heading, { level: 2, as: "h1", className: styles$9.title, "aria-label": title2, children: title2.split(" ").map((word2, index2) => /* @__PURE__ */ jsx("span", { className: styles$9.titleWordWrapper, children: /* @__PURE__ */ jsxs(
          "span",
          {
            className: styles$9.titleWord,
        ...
        /* @__PURE__ */ jsxs("div", { className: styles$9.details, children: [
          ...
          /* @__PURE__ */ jsx("div", { className: styles$9.timecode, children: timecode2 })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsx(Section, { className: styles$9.wrapper, id: "postContent", tabIndex: -1, children: /* @__PURE__ */ jsx(Text, { as: "div", size: "l", className: styles$9.content, children }) }),
    /* @__PURE__ */ jsx(Footer, {})
  ] });
};
...
const Code = (props) => {
  ...
  return /* @__PURE__ */ jsxs("div", { className: styles$8.code, "data-theme": theme, children: [
    !!lang2 && /* @__PURE__ */ jsx(Text, { secondary: true, size: "s", className: styles$8.lang, children: lang2 }),
    /* @__PURE__ */ jsx("pre", { ref: elementRef, ...props }),
    /* @__PURE__ */ jsx("div", { className: styles$8.actions, children: /* @__PURE__ */ jsx(Button, { iconOnly: true, onClick: handleCopy, "aria-label": "Copy", children: /* @__PURE__ */ jsxs("span", { className: styles$8.copyIcon, children: [
...
const List = ({ ordered, children, className, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Element, { className: classes(styles$7.list, className), ...rest, children });
};
const ListItem = ({ children, ...rest }) => {
  return /* @__PURE__ */ jsx("li", { className: styles$7.item, ...rest, children });
};
...
const PostHeadingLink = ({ id }) => {
  return /* @__PURE__ */ jsx(Link$1, { className: styles$6.headingLink, to: `#${id}`, "aria-label": "Link to heading", children: /* @__PURE__ */ jsx(Icon, { icon: "link" }) });
};
const PostH1 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$6.heading, id, level: 2, as: "h1", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH2 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$6.heading, id, level: 3, as: "h2", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH3 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$6.heading, id, level: 4, as: "h3", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostH4 = ({ children, id, ...rest }) => /* @__PURE__ */ jsxs(Heading, { className: styles$6.heading, id, level: 5, as: "h4", ...rest, children: [
  /* @__PURE__ */ jsx(PostHeadingLink, { id }),
  children
] });
const PostParagraph = ({ children, ...rest }) => {
  ...
  return /* @__PURE__ */ jsx(Text, { className: styles$6.paragraph, size: "l", as: "p", ...rest, children });
};
const PostLink = ({ ...props }) => /* @__PURE__ */ jsx(Link, { ...props });
const PostUl = (props) => {
  return /* @__PURE__ */ jsx(List, { className: styles$6.list, ...props });
};
const PostOl = (props) => {
  return /* @__PURE__ */ jsx(List, { className: styles$6.list, ordered: true, ...props });
};
const PostLi = ({ children, ...props }) => {
  return /* @__PURE__ */ jsx(ListItem, { ...props, children });
};
const PostCode = ({ children, ...rest }) => /* @__PURE__ */ jsx("code", { className: styles$6.code, ...rest, children });
const PostPre = (props) => {
  return /* @__PURE__ */ jsx("div", { className: styles$6.pre, children: /* @__PURE__ */ jsx(Code, { ...props }) });
};
const PostBlockquote = (props) => {
  return /* @__PURE__ */ jsx("blockquote", { className: styles$6.blockquote, ...props });
};
const PostHr = (props) => {
  return /* @__PURE__ */ jsx("hr", { className: styles$6.hr, ...props });
};
const PostStrong = (props) => {
  return /* @__PURE__ */ jsx("strong", { className: styles$6.strong, ...props });
};
...
const Embed = ({ src }) => {
  return /* @__PURE__ */ jsx("div", { className: styles$6.embed, children: /* @__PURE__ */ jsx("iframe", { src, loading: "lazy", title: "Embed" }) });
};
const postMarkdown = {
  h1: PostH1,
  h2: PostH2,
...
const headsetTexture = "/assets/headsetTexture-JFFFvqYo.jpg";
function subscribe() {
  return () => {
  };
}
...
const DisplacementSphere = lazy(
  () => import("./displacement-sphere-BGD6RZvF.js").then((module) => ({ default: module.DisplacementSphere }))
);
...
const profileImgLarge = "/assets/profile-CjMYAgeh.png";
...
const ProfileText = ({ visible, titleId }) => /* @__PURE__ */ jsxs(Fragment, { children: [
  /* @__PURE__ */ jsx(Heading, { className: styles$4.title, "data-visible": visible, level: 3, id: titleId, children: /* @__PURE__ */ jsx(DecoderText, { text: "Explorando Nuevas Realidades", start: visible, delay: 500 }) }),
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "Bienvenidos a Realidades (X), donde la creatividad y la tecnología se fusionan para transformar la percepción del mundo. Nos dedicamos a redefinir los límites con experiencias inmersivas en VR, AR, MR, videojuegos, IA, avatares y motion graphics. Aquí, cada proyecto es una ventana hacia lo inesperado, lo disruptivo, lo visionario." }),
  /* @__PURE__ */ jsx(Text, { className: styles$4.description, "data-visible": visible, size: "l", as: "p", children: "Desde el diseño en múltiples niveles hasta la interacción en mundos digitales, nos apasiona crear universos donde lo imposible se convierte en realidad. Si estás listo para desafiar las normas y explorar lo desconocido, te invitamos a unirte a nuestro viaje." })
] });
...
const headset = "/assets/oculus_quest_2-_39E33Zp.glb";
...
const deviceModels = {
  ...
  headset: {
    url: headset,
    // Ruta al archivo del modelo 3D del headset
    width: 1280,
    height: 800,
    position: { x: 0, y: 0, z: 0 }
  }
...
const Model = lazy(
  () => import("./index-BhG5F5Go.js").then((module) => ({ default: module.Model }))
);
function ProjectSummary({
  ...
  function renderPreview(visible) {
    return /* @__PURE__ */ jsxs("div", { className: styles$3.preview, children: [
      ...
      model2.type === "headset" && /* @__PURE__ */ jsxs(Fragment$1, { children: [
        renderKatakana("headset", visible),
        /* @__PURE__ */ jsxs("div", { className: styles$3.model, "data-device": "headset", children: [
          !modelLoaded && /* @__PURE__ */ jsx(Loader, { center: true, className: styles$3.loader, "data-visible": visible }),
          isHydrated && visible && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(
            Model,
            {
              ...
              models: [
                {
                  ...deviceModels.headset,
                  // Aquí se carga el modelo del headset
                  texture: {
                    ...model2.textures[0],
                    // Ajusta la textura si es necesario
...
const Home = () => {
  ...
  useEffect(() => {
    const sections = [intro2, projectOne, projectTwo, projectThree, projectFour, projectFive, projectSix, projectSeven, details2];
...
const serverManifest = { "entry": { "module": "/assets/entry.client-sEiNJUHc.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/root-BuzfLJ-q.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/index-BbOBZ9K4.js", "/assets/visually-hidden-BKiyG-lX.js", "/assets/use-spring-O0f1mO_4.js", "/assets/decoder-text-CqceCVFi.js", "/assets/error-08FEz0xn.js", "/assets/useScrollToHash-D9KvaZZL.js", "/assets/useWindowSize-CCgmKmhO.js", "/assets/config-CAdQL0d_.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/error-Cq_yTnRj.css", "/assets/root-Ci9I8dx3.css"] }, "routes/articles.modern-styling-in-react": { "id": "routes/articles.modern-styling-in-react", "parentId": "routes/articles", "path": "modern-styling-in-react", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.modern-styling-in-react-DlpEnr7l.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/index-DUWVTWgJ.js"], "css": [] }, "routes/projects.volkihar-knight": { "id": "routes/projects.volkihar-knight", "parentId": "root", "path": "projects/volkihar-knight", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-ZG5E6pxo.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/meta-CJPP75PB.js", "/assets/useParallax-DcGcWQco.js", "/assets/project-BHQpAnHK.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/project-CMTDR1YT.css", "/assets/route-Dgt82hGY.css"] }, "routes/projects.smart-sparrow": { "id": "routes/projects.smart-sparrow", "parentId": "root", "path": "projects/smart-sparrow", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-8gCTydJr.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/meta-CJPP75PB.js", "/assets/useParallax-DcGcWQco.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/visually-hidden-BKiyG-lX.js", "/assets/project-BHQpAnHK.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/project-CMTDR1YT.css", "/assets/route-INjNiGZW.css"] }, "routes/articles.hello-world": { "id": "routes/articles.hello-world", "parentId": "routes/articles", "path": "hello-world", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/articles.hello-world-DW9iq93e.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/index-DUWVTWgJ.js"], "css": [] }, "routes/articles_._index": { "id": "routes/articles_._index", "parentId": "root", "path": "articles", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BNnUcy3k.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/index-BbOBZ9K4.js", "/assets/visually-hidden-BKiyG-lX.js", "/assets/use-spring-O0f1mO_4.js", "/assets/meta-CJPP75PB.js", "/assets/decoder-text-CqceCVFi.js", "/assets/divider-aGSgxrrD.js", "/assets/useWindowSize-CCgmKmhO.js", "/assets/date-DvyCAN0s.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/divider-BGrE333F.css", "/assets/route-Cl8BF6JV.css"] }, "routes/projects.slice": { "id": "routes/projects.slice", "parentId": "root", "path": "projects/slice", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-m3ffICSF.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/meta-CJPP75PB.js", "/assets/useParallax-DcGcWQco.js", "/assets/slice-app-CvtkH059.js", "/assets/project-BHQpAnHK.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/project-CMTDR1YT.css", "/assets/route-Cvnrim9f.css"] }, "routes/api.set-theme": { "id": "routes/api.set-theme", "parentId": "root", "path": "api/set-theme", "index": void 0, "caseSensitive": void 0, "hasAction": true, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/api.set-theme-l0sNRNKZ.js?client-route=1", "imports": [], "css": [] }, "routes/articles": { "id": "routes/articles", "parentId": "root", "path": "articles", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-CAdjgoUK.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/divider-aGSgxrrD.js", "/assets/meta-CJPP75PB.js", "/assets/useParallax-DcGcWQco.js", "/assets/useScrollToHash-D9KvaZZL.js", "/assets/clamp-e7DugykH.js", "/assets/date-DvyCAN0s.js", "/assets/list-DSaZp2Y_.js", "/assets/index-DUWVTWgJ.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/divider-BGrE333F.css", "/assets/meta-CErneW72.css", "/assets/list-Bzmr24nT.css", "/assets/route-CIB4zeEr.css"] }, "routes/home": { "id": "routes/home", "parentId": "root", "path": "home", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BW7o-bdo.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/index-BbOBZ9K4.js", "/assets/visually-hidden-BKiyG-lX.js", "/assets/use-spring-O0f1mO_4.js", "/assets/slice-app-CvtkH059.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-CJPP75PB.js", "/assets/decoder-text-CqceCVFi.js", "/assets/useScrollToHash-D9KvaZZL.js", "/assets/divider-aGSgxrrD.js", "/assets/useWindowSize-CCgmKmhO.js", "/assets/route-BfDaRZvi.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/divider-BGrE333F.css", "/assets/route-D3R5eEKe.css"] }, "routes/uses": { "id": "routes/uses", "parentId": "root", "path": "uses", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-pVOzSBQx.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/meta-CJPP75PB.js", "/assets/useParallax-DcGcWQco.js", "/assets/list-DSaZp2Y_.js", "/assets/project-BHQpAnHK.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/list-Bzmr24nT.css", "/assets/project-CMTDR1YT.css", "/assets/route-DZeEc7Bh.css"] }, "routes/$": { "id": "routes/$", "parentId": "root", "path": "*", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": true, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": true, "module": "/assets/_-CYaR7Dtd.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/index-BbOBZ9K4.js", "/assets/visually-hidden-BKiyG-lX.js", "/assets/use-spring-O0f1mO_4.js", "/assets/decoder-text-CqceCVFi.js", "/assets/error-08FEz0xn.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/error-Cq_yTnRj.css"] }, "routes/home/route": { "id": "routes/home/route", "parentId": "root", "path": "/", "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasErrorBoundary": false, "module": "/assets/route-BW7o-bdo.js?client-route=1", "imports": ["/assets/jsx-runtime-BfF-YriY.js", "/assets/components-Da5qlHjh.js", "/assets/image-DoYySQdS.js", "/assets/config-CAdQL0d_.js", "/assets/index-BbOBZ9K4.js", "/assets/visually-hidden-BKiyG-lX.js", "/assets/use-spring-O0f1mO_4.js", "/assets/slice-app-CvtkH059.js", "/assets/spr-lesson-builder-dark-placeholder-CxlvWxWS.js", "/assets/meta-CJPP75PB.js", "/assets/decoder-text-CqceCVFi.js", "/assets/useScrollToHash-D9KvaZZL.js", "/assets/divider-aGSgxrrD.js", "/assets/useWindowSize-CCgmKmhO.js", "/assets/route-BfDaRZvi.js"], "css": ["/assets/image-6SULZPfv.css", "/assets/meta-CErneW72.css", "/assets/visually-hidden-NrYl-3i8.css", "/assets/decoder-text-BAWoexd9.css", "/assets/divider-BGrE333F.css", "/assets/route-D3R5eEKe.css"] } }, "url": "/assets/manifest-6500111a.js", "version": "6500111a" };
